...
On 29th October I travelled over to Cardiff for twos days at [theweb.is conference](http://theweb.is). The whole conference was put together to celebrate the 25th anniversay of the web, with all the talks being based around what the web is to each speaker. Based on this concept there was always going to be a broard range of topics, however I was surprised at just how broad.
...
* [A nice succint over view from a nice fella (who I ate noodles with) called Mike Dunn](http://mkdnn.com/2014/11/02/the-web-is/)
...
* [Phil Hawksworth - The Web is Links](#The Web is Links)
...
His talk centred around the role of the educator and opened his talk with the [“O captain, my captain” scene from “Dead Poets Society”](https://www.youtube.com/watch?v=u_N6ezGK8XE). The contrast in clip between how the students interact with Mr. Nolan and Mr. Keating is fairly stark. Mr. Nolan teaches in the classic read and learn style where as Mr. Keating doesn’t just tell them what poetry is, he shares his knowledge and discusses it with them, but he also teaches them other life lessons along the way. he doesn’t just stick blindly to the agreed (and out of date) syllabus and and this is why the students risk punishment to show their support for him.

Chris described this as a new old way of teaching, going back to the days of the master and apprentice, where the master craftsmen would take on a single apprentice and teach them everything they know until the apprentice is on the same level, then apprentice would then go out as a journeyman and learn from a different master and keep progressing way above the original master. Currently it seems that most education is based around getting the end qualification, with no support around it. This leaves students with the knowledge of a subject but not the skills to use it and more importantly without the belief to reach their full potential. 
...
We missed the first half this talk (due to getting stuck in the carpark) which was a shitter as I was really looking forward to it. However what I did see of the talk apparently really resonated with me (I only realise this as I’m writing up my notes).
...
Be authentic and you’ll customers will see that you care.
...
This is exhasting and it makes us constantly question our tools and ourselves, if we fall behind the curve we feel like we are failing, like an imposter in our jobs. 
...
His talk focused around the fundamental building block of the web, the link. We can link to absolutely anything (thats not behind a paywall), joining two things together and creating something more. 

After a brief bit of wonder at how amazing the humble link really is he moved on to discussing how we are destroying this link. He expanded on his definition of the link to include the URL (URI) and how we have gone down this path where we are making our URL's too convulted and forgetting that these URL's are supposed to be human readable.. Infact... That's pretty much their sole purpose. 

We've ruined these URL's to the point where browsers are starting to hide them, which is insane, as Phil quoted Jake Archibald - “the URL is the share button of the web”.

Phil then moved his talk onto progressive enhancement, pulling out one of my favourite web quotes, “This is for everyone (with javascript enabled)” - Dan Williams. At it's most basic the web is html pages linked to other html pages. We all hear everyone say "But everyone has js enabled now". Phil's response to that (paraphrased by me) is - more than 60% of the population of India (a shit ton) is offline - when the come online the devices they are using will be basic, very basic. 
...
This was an interesting one... It wasn't actually a talk... Andy runs a podcast called [unfinished business](http://unfinished.bz/) about "the business end, the sharp end of web, design and creative industries" and his "talk" was actually a live recording of his podcast. The topic discussed was mental health in the web industry. The conference coincided with ["Geek Mental Help Week"](http://geekmentalhelp.com/). Andy was joined by three guests, Chris Murphy, Cole Henley, Relly Annett-Baker and Dr. Clare Symons. 

Cole Henley and Relly Annett-Baker talked through their previous mental problems whilst Dr. Clare Symons gave an outside professional perspective on mental health in our industry. 
...
That's it feel free to ping me an [email](mailto(nickphillipps@nickphillipps.co.uk)) or tweet.
